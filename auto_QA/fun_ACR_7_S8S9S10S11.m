...
%  in: 11 1 1 0 out: 10 zeros(3, 10)
%  in:  9 1 1 0 out: 10 zeros(3, 10)
%  in:  8 1 1 0 out: 10 zeros(3, 10)
% out: cnt = 10;
% out: LCOD = zeros(3, 10);
...
switch manual
    ...
    case 0
        ...
        I_mask=fun_segCroissRegion(1,I_bin,ind_centre(1,1),ind_centre(1,2),0);
        if visual==1
            figure;
        ...
        LCOD=zeros(3,10); % Add by Achilles
        %====================v7 finish====================
        %         %9.sample circumference intensity of 3 radius for spokes
